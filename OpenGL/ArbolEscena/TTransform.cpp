...
TTransform::TTransform() {
	//al constructor se le puede pasar una variable para indentificar que tipo de transformacion se va a realizar
}
//----------------------------//
//-----GESTIONAR LA MATRIZ----//
//----------------------------//
...
*/
	...
	matriz =  matriz * glm::translate(glm::mat4(), glm::vec3(x, y, z));
...
*/
	...
	matriz = matriz * glm::rotate(g, myRotationAxis);
