...
/*Clase que crea un area cubica, especificando ancho, alto y largo, donde crea un numero
determinado de nubes, situandolas aleatoriamente en dicha area*/
...
class cloudGenerator{
    ...
    private:
        // --- VARIABLES ---
        int numClouds; //Numero de nubes creadas en el area de creacion
