...
enum tipo_nodo { NADA2, IGUAL, DISTINTO, MAYOR, MAYOROIGUAL, MENOR, MENOROIGUAL };

enum tipo_parametro {
	NADA3, OBJNUMERO, OBJBOOLEANO, DISTANCIACERCA, DISTANCIAMEDIA, DISTANCIALEJOS,
	...
	CAJA, TURBOO, ENEMIGO, VISION, ENEMIGOLADO, HABILIDADD, JUGADOR
};
