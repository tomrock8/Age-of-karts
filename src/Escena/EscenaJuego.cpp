...
void EscenaJuego::init() {
	...
	// LUCES
	obj3D * luzPuntual_0 = TMotor::instancia().newLightNode("light_0", glm::vec4(-1.0f, -1.f, -1.0f, 0.0f), 0.0001f, glm::cos(glm::radians(60.0f)), true, "escena_raiz");
	luzPuntual_0->translate(glm::vec3(2.5f, 12.0f, 2.0f));

	
	obj3D * luzPuntual_1 = TMotor::instancia().newLightNode("light_1", glm::vec4(-1.0f, -1.f, -1.0f, 0.0f), 0.0001f, glm::cos(glm::radians(60.0f)), true, "escena_raiz");
	luzPuntual_1->translate(glm::vec3(0.0f, 12.0f, 150.0f));
	
	obj3D * luzPuntual_2 = TMotor::instancia().newLightNode("light_2", glm::vec4(-1.0f, -1.f, -1.0f, 0.0f), 0.0001f, glm::cos(glm::radians(60.0f)), true, "escena_raiz");
